...
```bash
git clone git@github.com:nando-experiments/hello-gas.git
cd hello-gas/
npm install
```
...
## Dependecies
 ...
 - [@types/google-apps-script](https://github.com/DefinitelyTyped/DefinitelyTyped) - TypeScript definitions for google-apps-script
